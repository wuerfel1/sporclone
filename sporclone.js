...
function end()
{
    ...
    for (var i=0; i<is_guessed.length; i++)
    {
        ...
        document.getElementById(id).innerHTML = answers[i].split("|")[0];

        // y.
        if (is_guessed[i]==true)
        {
            document.getElementById("answer"+i).style.backgroundColor = "#00FF00";
        }
        else
        {
            document.getElementById("answer"+i).style.backgroundColor = "#FF0000";
        }
